var seedSpeakers = function () {
    ...
    Speaker.create({
        name: 'Maged Farrag',
        bio: `MagedFarrag is a digital media evangelist, founded his first company Mega Media in 1994 to become Egypt’s leading multimedia service provider. 
            ...
            use of technology in advertising, communication and cultural heritage documentation. He has received numerous advertising and content awards. <br>
            ...
            a company specialized in creating VR/AR content and solutions. <br>
    ...
    Speaker.create({
        ...
        bio: `Mr. Shady is currently working as Regional Quality Manager for General Motors North Africa, based in Cairo, Egypt. 
            ...
            the Middle East since 2013, as well as a reviewer of technical paper in ASQ Quality Conferences on 2015 and 2016. <br>
            ...
            Shady coached more than 60 Red X & Six Sigma projects resulting in savings of more than 20 million US $. <br>
            ...
            refereed journals and conferences. In 2013, he published his book “Critical Success Factors of Six-sigma in Automotive Industry”. <br>
    ...
    Speaker.create({
        name: 'Vortex',
        bio: `Driven by the dream of winning an ROV competition, Vortex was founded back in 2015 by 8 electromechanical engineers in Alexandria University. <br>
            ...
            they were able to break both the Egyptian and Arabic records. Vortex rapidly succeeded not only in ROV competitions but also in other national forums. <br>
...
`
    ...
    Speaker.create({
        ...
        bio: `Mohammad joined Fab Lab Egypt's team as a web developer before becoming head of I.T. <br>
                ...
                were used to plan and have a better understanding of operations beforehand. <br>
    ...
    Speaker.create({
        ...
        bio: `Mohram holds more than 5 years of experience in various fields such as: teaching and research. In addition to consulting in structural 
            engineering with major projects in Middle-East, Far East and Gulf Area. <br>
            ...
            assistant in the Faculty of Engineering, Alexandria University. <br>

            Being a teacher assistant, Mohram was able to leave a mark in every place he worked in, such as JAMES CUBBIT & PARTENERS and AAST. <br>
    ...
    Speaker.create({
        ...
        bio: `Pegasus team is one of the scientific teams in Faculty of Engineering, Alexandria University, in addition to being the representative 
            team of Egypt and the Arab world in SAE Aerodesign West Competition, in which the team ranked ninth out of 34 participating teams. <br>

                Pegasus team’s main interest is Aviation Science in all its scientific and research fields. <br>
